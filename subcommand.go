...
func (sab *SubcommandArgBuilder) FieldValuesFrom(sourceFlag, fieldArg string) *SubcommandArgBuilder {
	sab.sfb.spec.ArgCompleters[sab.argIndex] = &FieldValueCompleter{
