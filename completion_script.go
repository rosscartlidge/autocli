...
#
# This script uses a shared completion function (_completionflags_complete)
# that works for all programs built with completionflags.
...
complete -F _completionflags_complete %s
